            ...
            <li class="profile">
                <div class="li-profile-info">
                    ...
                    <div class="emailprofile"><a href="https://uidevr.com/cdn-cgi/l/email-protection"
                            class="__cf_email__"
                            data-cfemail="c1a4aca0a8ad81a4aca0a8adefa2aeac">[email&#160;protected]</a></div>
                    <div class="balance">
                ...
                <div class="row">
                    <form class="col s12">
                        <div class="payment-method-wrap ck-box">
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="choose-payment-method">Choose your payment method :</div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12 ">
                                    <p>
                                        ...
                                        <label for="test3">Direct Bank Transfer</label>
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col s12 m12 l12 ">
                                    <p>
                                        ...
                                        <label for="test4">Check Payment</label>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="billing-detail-wrap ck-box">
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <div class="payment-method-text">
                                        <i class="far fa-id-card"></i> Billing Detail
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col s12">
                                    <div class="billing-deatail-form-text">Fill in the form your billing detail :</div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <input id="billing-firstname" type="text" class="validate">
                                    <label for="billing-firstname">First Name</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <input id="billing-lastname" type="text" class="validate">
                                    <label for="billing-lastname">Last Name</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <input id="billing-email" type="email" class="validate">
                                    <label for="billing-email">Email</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <input id="billing-phone" type="tel" class="validate">
                                    <label for="billing-phone">Phone</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <textarea id="billing-address" class="materialize-textarea"></textarea>
                        ...
                        <div class="shipping-info-wrap ck-box">
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="new-shipping-address">New shipping address :</div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                            ...
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    <input id="info-lastname" type="text" class="validate">
                                    <label for="info-lastname">Last Name</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <p>
                                    ...
                                    <label class="label-checkbox" for="filled-in-box"> I agree that i have read and

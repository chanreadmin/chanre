...
<body id="homepage">
    ...
    <div id="page-content" class="product-page"> 
        ...
        $iquery = mysqli_query($con, "Select tbl_dietlist.id,tbl_dietlist.calories,tbl_dietlist.protien,
        tbl_dietlist.carbohydrate, tbl_dietlist.fat, tbl_dietlist.fibre,
        tbl_dietlist.item, tbl_assigndiet.quantity, 
          tbl_assigndiet.diet_id,tbl_assigndiet.type from tbl_dietlist INNER JOIN tbl_assigndiet
           ON tbl_dietlist.id = tbl_assigndiet.diet_id where tbl_assigndiet.diet_id = '$diet_no' LIMIT 1");

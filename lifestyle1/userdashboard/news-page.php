...
<!-- Mirrored from uidevr.com/tf/asiapp/news-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 07:00:03 GMT -->
<head>
<meta charset="UTF-8">
...
<ul id="nav-mobile-category" class="side-nav">
  <li class="profile">
    <div class="li-profile-info">
      ...
      <h2>John Doe</h2>
      <div class="emailprofile"><a href="https://uidevr.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8ce9e1ede5e0cce9e1ede5e0a2efe3e1">[email&#160;protected]</a></div>
      <div class="balance">
       ...
       <div class="news-content">
        <br>
            <div class="news-detail">
              ...
              <p>
                 Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi error quibusdam culpa assumenda maiores ea dicta fuga a itaque rerum deserunt, incidunt, nulla, vero amet sapiente reiciendis. Perspiciatis debitis, accusamus? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus eligendi porro deleniti quisquam omnis rem quibusdam corporis alias, et quae, assumenda unde pariatur vitae placeat veritatis nam quia, velit delectus. <br><br>
                 Perspiciatis debitis, accusamus? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus eligendi porro deleniti quisquam omnis rem quibusdam corporis alias, et quae, assumenda unde pariatur vitae placeat veritatis nam quia, velit delectus. 
              </p> 
            </div>
          </div>
      </div>
     ...
     <div class="col s12">
       <div class="share-via">
          <ul>
            ...
            <li class="s-icon"><a href="#"><i class="fab fa-twitter-square"></i></a></li>
            <li class="s-icon"><a href="#"><i class="fab fa-facebook-square"></i></a></li>
            <li class="s-icon"><a href="#"><i class="fab fa-google-plus-square"></i></a></li>
            <li class="s-icon"><a href="#"><i class="fab fa-linkedin"></i></a></li>
          </ul>
        </div>
     </div>
   </div>
    ...
    <div class="row">
      <div class="col s12">
        <div class="comment-wrap">
          <div class="v-comment">2 Comments</div>

          <!-- item comment -->
          <div class="comment-box">
            <div class="cb-left">
              <div class="cb-photo">
                <img src="img/profile2.jpg" alt="photo">
              </div>
            </div>
            <div class="cb-right">
              <div class="cbr-name">John Doe</div> 
              <div class="cbr-comment">Lorem ipsum dolor sit amet, consectetur</div>
            </div>
            <div class="clear"></div>
          </div>
          <!-- end item comment -->
          ...
          <div class="comment-box">
            <div class="cb-left">
              <div class="cb-photo">
                <img src="img/profile5.jpg" alt="photo">
              </div>
            </div>
            <div class="cb-right">
              <div class="cbr-name">Jane Doe</div> 
              <div class="cbr-comment">Lorem ipsum dolor sit amet, consectetur</div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <br>
           <div class="v-comment">Leave a Reply</div>
...
<!-- Mirrored from uidevr.com/tf/asiapp/news-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 07:00:08 GMT -->
</html>
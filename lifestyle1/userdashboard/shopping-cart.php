...
<!-- Mirrored from uidevr.com/tf/asiapp/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 06:59:59 GMT -->
<head>
<meta charset="UTF-8">
...
<ul id="nav-mobile-category" class="side-nav">
  <li class="profile">
    <div class="li-profile-info">
      ...
      <h2>John Doe</h2>
      <div class="emailprofile"><a href="https://uidevr.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5e3b333f37321e3b333f3732703d3133">[email&#160;protected]</a></div>
      <div class="balance">
        ...
        <div class="col s12">
          <div class="cart-box">
            ...
            <div class="cart-item">
              ...
              <div class="ci-name">
                <div class="cin-top">
                  <div class="cin-title">Herbal Drink</div>
                  <div class="cin-price">$ 5.00</div>
                </div>
              </div>
              <div class="ci-price">
                <div class="qty-total-price">
                  <div class="qty-prc">
                    <div class="quantity">
                      <input type="number" min="0" max="9999" step="1" value="1"></div>
                  </div>
                </div>
              </div>
              <div class="clear"></div>
            ...
            <div class="cart-item">
              ...
              <div class="ci-name">
                <div class="cin-top">
                  <div class="cin-title">Vitamin</div>
                  <div class="cin-price">$ 8.00</div>
                </div>
              </div>
              <div class="ci-price">
                <div class="qty-total-price">
            ...
            <div class="cart-item">
              ...
              <div class="ci-name">
                <div class="cin-top">
                  <div class="cin-title">Suplemen</div>
                  <div class="cin-price">$ 5.00</div>
                </div>
              </div>
              <div class="ci-price">
            ...
            <div class="cart-item">
              ...
              <div class="ci-name">
                <div class="cin-top">
                  <div class="cin-title">Tablet</div>
                  <div class="cin-price">$ 7.00</div>
                </div>
              </div>
              <div class="ci-price">
                <div class="qty-total-price">

...
<!-- Mirrored from uidevr.com/tf/asiapp/our-doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 06:59:51 GMT -->
<head>
<meta charset="UTF-8">
...
<ul id="nav-mobile-category" class="side-nav">
  <li class="profile">
    <div class="li-profile-info">
      ...
      <h2>John Doe</h2>
      <div class="emailprofile"><a href="https://uidevr.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="791c14181015391c14181015571a1614">[email&#160;protected]</a></div>
      <div class="balance">
      ...
      <div class="row row-title ">
        <div class="col s12">
          <div class="section-title row-title-team">
            <span class="theme-secondary-color">OUR</span> DOCTORS
          </div>
        </div>
      </div>
      <div class="row row-title ">
        <div class="col s12 center">
         Find our Doctor specialist, Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.<br><br>
        </div>
      </div>
      <!-- item -->
      <div class="row row-team">
        <div class="col s12">
          <div class="wrap-team">
            <div class="wt-left">
              <div class="wt-photo">
                <img src="img/doctor5.jpg" alt="doctor">
              </div>
            </div>
            <div class="wt-right">
              <div class="wtr-name">Dr. Eta Doe</div>
              <div class="wtr-title">Dermatology Specialist</div>
              <div class="wtr-info">Lorem ipsum dolor sit amet, consectetur</div>
              <div class="wtr-sosmed">
                <div class="sosmed-icon">
                  <a href="#" class="facebook-bg icon-round">
                  <div class="wtr-icon">
                    <i class="fab fa-facebook-f"></i>
                  </div>
                  </a>
                  <a href="#" class="twitter-bg icon-round">
                  <div class="wtr-icon">
      ...
      <div class="row row-team">
        <div class="col s12">
          <div class="wrap-team">
            <div class="wt-left">
              <div class="wt-photo">
                <img src="img/doctor4.jpg" alt="doctor">
              </div>
            </div>
            <div class="wt-right">
              <div class="wtr-name">Dr. John Doe</div>
              <div class="wtr-title">Neurology Specialist</div>
              <div class="wtr-info">Lorem ipsum dolor sit amet, consectetur</div>
              <div class="wtr-sosmed">
                <div class="sosmed-icon">
                  <a href="#" class="facebook-bg icon-round">
      ...
      <div class="row row-team">
        <div class="col s12">
          <div class="wrap-team">
            ...
            <div class="wt-right">
              <div class="wtr-name">Dr. Jane Doe</div>
              <div class="wtr-title">Public Health</div>
              <div class="wtr-info">Lorem ipsum dolor sit amet, consectetur</div>
              <div class="wtr-sosmed">
                <div class="sosmed-icon">
                  <a href="#" class="facebook-bg icon-round">
      ...
      <div class="row row-team">
        <div class="col s12">
          <div class="wrap-team">
            ...
            <div class="wt-right">
              <div class="wtr-name">Dr. Tayo</div>
              <div class="wtr-title">Dermatology Specialist</div>
              <div class="wtr-info">Lorem ipsum dolor sit amet, consectetur</div>
              <div class="wtr-sosmed">
                <div class="sosmed-icon">
      ...
      <div class="row row-team">
        <div class="col s12">
          <div class="wrap-team">
            ...
            <div class="wt-right">
              <div class="wtr-name">Dr. John Doe</div>
              <div class="wtr-title">Cardiology Specialist</div>
              <div class="wtr-info">Lorem ipsum dolor sit amet, consectetur</div>
              <div class="wtr-sosmed">
                <div class="sosmed-icon">
                  <a href="#" class="facebook-bg icon-round">
...
<!-- Mirrored from uidevr.com/tf/asiapp/our-doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 06:59:56 GMT -->
</html>
...
<ul id="nav-mobile-category" class="side-nav">
  <li class="profile">
    <div class="li-profile-info">
      ...
      <h2>John Doe</h2>
      <div class="emailprofile"><a href="https://uidevr.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="99fcf4f8f0f5d9fcf4f8f0f5b7faf6f4">[email&#160;protected]</a></div>
      <div class="balance">
...
<div id="page-content" class="product-page">
    ...
    <div class="row">
      <div class="col s12">
        <div class="name-price">
          <div class="pg-product-name">Medicine</div>
          <div class="pg-product-price">$4.00</div>
          <div class="clear"></div>
        </div>
      </div>
    </div>
  ...
  <div class="desciption-product">
    <div class="container">
      <div class="row">
        <div class="col s12">
           You can use this page as product page, with some product image in carousel. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.
        </div>
      </div>
    </div>
  </div>
...
<!-- Mirrored from uidevr.com/tf/asiapp/product-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 06:59:59 GMT -->
</html>
...
<!-- Mirrored from uidevr.com/tf/asiapp/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 07:00:08 GMT -->
<head>
<meta charset="UTF-8">
...
<ul id="nav-mobile-category" class="side-nav">
  <li class="profile">
    <div class="li-profile-info">
      ...
      <h2>John Doe</h2>
      <div class="emailprofile"><a href="https://uidevr.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b7d2dad6dedbf7d2dad6dedb99d4d8da">[email&#160;protected]</a></div>
      <div class="balance">
      ...
      <div class="row">
        <div class="col s12">
          ...
          <div class="filter-gallery">
            <button data-filter="gallery-no-filter" class="filter-button active">All</button>
            <button data-filter="gallery-drink" class="filter-button">Drink</button>
            <button data-filter="gallery-food" class="filter-button">Food</button>
            <button data-filter="gallery-sport" class="filter-button">Sport</button>
...
<!-- Mirrored from uidevr.com/tf/asiapp/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2023 07:00:14 GMT -->
</html>
...
header('location:index.php');
  ...
  if(isset($_POST['submit']))
  {
    ...
    values('$PostDate','$grbps','$bp','$pulse','$spo2','$pweight','$pheight','$bodyfat','$visceralfat',
                            ...
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    ...
                                    <form class="row g-3" method="POST">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="grbps" placeholder="GRBS">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="bodyfat"
                                                placeholder="Body Fat">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="visceralfat"
                                                placeholder="Visceral Fat">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="musclefat"
                                                placeholder="Muscle Fat">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="bmi" placeholder="BMI(Kg/m2)">
                                        </div>

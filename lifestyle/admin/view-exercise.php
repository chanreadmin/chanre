                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-container">
                                                        <div><strong>First Set:</strong>
                                                            <?php echo htmlentities($frows['set1']) ?> Reps</div>
                                                        <div><strong>Second Set:</strong>
                                                            <?php echo htmlentities($frows['set2']) ?> Reps</div>
                                                        <div><strong>Third Set:</strong>
                                                            <?php echo htmlentities($frows['set3']) ?> Reps</div>
                                                    </div>

                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fs-5 ms-auto dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="add-prescription.php?pid=<?php echo $sid; ?>">Add
                                            Report</a>
                                    </li>
                                    <!--<li><a class="dropdown-item" href="#">Another action</a></li>
                                        -->
                        ...
                        <div class="table-responsive mt-2">
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php
                                        $mquery = mysqli_query($con, "Select * from tbl_prescription where patient_id= $sid");
                                        while ($frows = mysqli_fetch_array($mquery)) {
                                        ?>
                                    <tr>
                                        <td>
                                            <?php echo htmlentities($frows['drug_name']) ?>
                                        </td>
                                        <td>
                                            <?php echo htmlentities($frows['drug_dosage']) ?>
                                        </td>
                                        <td>
                                            <?php echo $frows['med_insruction'] ?>
                                        </td>
                                        <td>
                                            <?php echo htmlentities($frows['drug_duration']) ?>
                                        </td>
                                        <td>
                                            <!-- <a href="#?pid=<?php echo htmlentities($frows['patient_id']) ?>">View</a> -->
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>

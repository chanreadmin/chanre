                    ...
                    <div class="card-body">
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><a
                                                href="edit-joint-assestment.php?pid=<?php echo htmlentities($frows['id']) ?>">View
                                                & Edit</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fs-5 ms-auto dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="add-excercise-suggestion.php?pid=<?php echo $sid; ?>">Add Report</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="table-responsive mt-2">
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php 
                                    $query = mysqli_query($con, "SELECT * from tbl_assign_excercise WHERE patient_id = '$sid'");

                            ...
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    ...
                                    <form class="row g-3" method="POST">
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="hb" placeholder="hb" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="crp" placeholder="crp" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="rbs" placeholder="rbs" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="hba1c" placeholder="hba1c" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="lipid_profile" placeholder="Lipid profile" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="t3" placeholder="T3" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="t4" placeholder="T4" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="tsh" placeholder="TSH" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="lft" placeholder="LFT" required>
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="creatinine" placeholder="Creatinine">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="electrolyte" placeholder="Electrolyte">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" name="other" placeholder="Others(If any..)">
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">

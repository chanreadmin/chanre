                ...
                <div class="row">
                    ...
                    <div class="col-xl-10 mx-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    <h6 class="mb-0 text-uppercase text-center text-primary">Yoga</h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-2">
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php
                                        $fquery = mysqli_query($con, "Select * from tbl_yogalist");
                                        while ($frows = mysqli_fetch_array($fquery)) {
                                        ?>
                                    <tr>
                                        <td>
                                            <?php echo htmlentities($frows['asana_name']) ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#exampleVerticallycenteredModal<?php echo htmlentities($frows['id']) ?>"><img
                                                    height="30" width="30"
                                                    src="postimages/<?php echo htmlentities($frows['yogapics'])  ?>"></button>
                                        </td>


                                        <td><a
                                                href="edit-yoga.php?pid=<?php echo htmlentities($frows['id']) ?>">Edit</a>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">
                                                        <?php echo htmlentities($frows['asana_name']) ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <img src="postimages/<?php echo htmlentities($frows['yogapics'])  ?>">
                                                    <div class="modal-container">
                                                        
                                                    </div>
                                                    <div style="width:300px;"><small><?php /* $pt=$frows['description'];  echo  (substr($pt,0));  */ ?></small></div>
                                                </div>

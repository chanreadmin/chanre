<aside class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li class="menu-label">Users Sections</li>
        <li>
            <a href="javascript:;" class="has-arrow">
                <div class="parent-icon">
            ...
            <ul>
                <li> <a href="add-patient.php">
                        <ion-icon name="ellipse-outline"></ion-icon>Add Patient
                    </a>
                </li>
                <li> <a href="view-patient.php">
                        <ion-icon name="ellipse-outline"></ion-icon>View Patient
                    </a>
                </li>
            </ul>
        </li>
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Diet</div>
            </a>
            <ul>
                <li>
                    <a href="add-food.php">
                        <ion-icon name="ellipse-outline"></ion-icon>Add Meals
                    </a>
                </li>
                <li>
                    <a href="view-meals.php">
                        <ion-icon name="ellipse-outline"></ion-icon>View Meals
                    </a>
                </li>
                <!--<li> <a href="add-patient.php">
                        <ion-icon name="ellipse-outline"></ion-icon>Add Patient
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Exercise</div>
            </a>
            <ul>
                <li>
                    <a href="add-excercise.php">
                        <ion-icon name="ellipse-outline"></ion-icon>Add Excercise
                    </a>
                </li>
                <li>
                    <a href="view-exercise.php">
                        <ion-icon name="ellipse-outline"></ion-icon>View Excercise
                    </a>
                </li>
            </ul>
        </li>
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Yoga</div>
            </a>
            <ul>
                <li>
                    <a href="add-yoga.php">
                        <ion-icon name="ellipse-outline"></ion-icon>Add Yoga
                    </a>
                </li>
                <li>
                    <a href="view-yoga.php">
                        <ion-icon name="ellipse-outline"></ion-icon>View Yoga List
                    </a>
                </li>
            </ul>
        </li>

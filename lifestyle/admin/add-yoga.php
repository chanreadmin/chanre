...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $queryinv = mysqli_query($con, "Insert into tbl_yogalist(asana_name, category, description,yogapics)
        values('$asananame','$category','$description','$imgnewfile')");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    <h6 class="mb-0 text-uppercase">Add Yoga</h6>
                                    <hr>
                                    <form class="row g-3" method="post" enctype="multipart/form-data" >
                                        <div class="col-md-6">
                                            <label for="validationCustom01" class="form-label">Asana Name</label>
                                            <input type="text" class="form-control" id="validationCustom01" name="asananame" placeholder="Asana Name" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="category" id="category" required>
                                                ...
                                                <option value="Loosing Excerice">Loosing Excercise</option>

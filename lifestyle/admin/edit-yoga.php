...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
       ...
       //Fetch User Details
        ...
        $queryinv = mysqli_query($con, "update tbl_yogalist set asana_name = '$asana_name',
        category='$category', description='$description', yogapics='$imgnewfile' where id = $sid");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    ...
                                    <hr>
                                    <?php 
                                    $queryfetch = mysqli_query($con, "SELECT * from tbl_yogalist where id=$sid");
                                    ...
                                    <form class="row g-3" method="post" enctype="multipart/form-data">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" value="<?php echo htmlentities($trows['asana_name']); ?>" class="form-control" id="validationCustom01" name="exercisename" placeholder="item" 
                                                required>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <span class="demo-img"><img  src="postimages/<?php echo htmlentities($trows['yogapics']); ?>"></span>
                                           <br>
                                            <label class="form-label">Demo</label>
                                            <input class="result form-control" type="file" id="demo" name="demo" value="<?php echo htmlentities($trows['yogapics']); ?>"
                                                >
                                        </div>

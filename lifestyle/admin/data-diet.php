                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fs-5 ms-auto dropdown">
                                <div><a class="" href="add-diet-assesment.php?pid=<?php echo $sid; ?>"><i
                                            class="bi bi-plus-square-fill"></i></a></div>
                            ...
                            <form class="row g-3 needs-validation" novalidate method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Food dislike?</td>
                                        <td>
                                            <input type="text" name="fd" value="<?php echo htmlentities($rows['fd']);?>"
                                                class="form-control">
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fs-5 ms-auto">
                                <div class=""><a class="" href="daywise-diet.php?pid=<?php echo $sid; ?>"><i
                                            class="bi bi-plus-square-fill"></i></a></div>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        FROM tbl_assigndiet
                                        where patient_id = $sid ORDER BY week DESC");
                                    ...
                                    <tr class="delete_mem<?php echo htmlentities($frows['id']); ?>">
                                        ...
                                        <td>
                                            <?php echo htmlentities($frows['patient_feedback']) ?>
                                        </td>

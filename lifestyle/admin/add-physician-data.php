                            ...
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    ...
                                    <form class="row g-3" method="POST">
                                        <div class="col-6">
                                            <select name="ci" id="ci" class="form-control" onchange="myFunction()">
                                        ...
                                        <hr>
                                        <div class="col-6">
                                            <select name="ri" id="ri" class="form-control" onchange= "respiratory_involvement()">
                                                <option value="">Select an option</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <hr>
                                        <div class="col-6">
                                            <select name="git" id="git" class="form-control" onchange="git_involvement()">
                                                <option value="">Select an option</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <hr>
                                        <div class="col-6">
                                            <select name="ni" id="ni" class="form-control" onchange="neurological_involvement()">
                                                <option value="">Select an option</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <hr>
                                        <div class="col-6">
                                            <select name="renal" id="renal" class="form-control" onchange="renal_involvement()">
                                                <option value="">Select an option</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        ...
                                        <hr>
                                        <div class="col-6">
                                            <select name="msk" id="msk" class="form-control" onchange="msk_involvement()">
                                                <option value="">Select an option</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
...
function myFunction() {
  ...
  if(a == 'No'){
    document.getElementById("ihd").disabled = true;
    document.getElementById("ihd_duration").disabled = true;
    document.getElementById("ihd_treatment").disabled = true;
    document.getElementById("valv").disabled = true;
    document.getElementById("valv_duration").disabled = true;
    document.getElementById("valv_treatment").disabled = true;
    document.getElementById("hf").disabled = true;
    document.getElementById("hf_duration").disabled = true;
    document.getElementById("hf_treatment").disabled = true;
    document.getElementById("cardother").disabled = true;
    document.getElementById("cardother_duration").disabled = true;
    document.getElementById("cardother_treatment").disabled = true;
    
  }
  else{
    document.getElementById("ihd").disabled = false;
    document.getElementById("ihd_duration").disabled = false;
    document.getElementById("ihd_treatment").disabled = false;
    document.getElementById("valv").disabled = false;
    document.getElementById("valv_duration").disabled = false;
    document.getElementById("valv_treatment").disabled = false;
    document.getElementById("hf").disabled = false;
    document.getElementById("hf_duration").disabled = false;
    document.getElementById("hf_treatment").disabled = false;
    document.getElementById("cardother").disabled = false;
    document.getElementById("cardother_duration").disabled = false;
    document.getElementById("cardother_treatment").disabled = false;
...
function respiratory_involvement(){
    var a= document.getElementById('ri').value;
  if(a == 'No'){
    document.getElementById("copd").disabled = true;
    document.getElementById("copd_duration").disabled = true;
    document.getElementById("copd_treatment").disabled = true;
    document.getElementById("ba").disabled = true;
    document.getElementById("ba_duration").disabled = true;
    document.getElementById("ba_treatment").disabled = true;
    document.getElementById("ild").disabled = true;
    document.getElementById("ild_duration").disabled = true;
    document.getElementById("ild_treatment").disabled = true;
    document.getElementById("tb").disabled = true;
    document.getElementById("tb_duration").disabled = true;
    document.getElementById("tb_treatment").disabled = true;
    document.getElementById("riother").disabled = true;
    document.getElementById("riother_duration").disabled = true;
    document.getElementById("riother_treatment").disabled = true;
  }
  else{
    document.getElementById("copd").disabled = false;
    document.getElementById("copd_duration").disabled = false;
    document.getElementById("copd_treatment").disabled = false;
    document.getElementById("ba").disabled = false;
    document.getElementById("ba_duration").disabled = false;
    document.getElementById("ba_treatment").disabled = false;
    document.getElementById("ild").disabled = false;
    document.getElementById("ild_duration").disabled = false;
    document.getElementById("ild_treatment").disabled = false;
    document.getElementById("tb").disabled = false;
    document.getElementById("tb_duration").disabled = false;
    document.getElementById("tb_treatment").disabled = false;
    document.getElementById("riother").disabled = false;
    document.getElementById("riother_duration").disabled = false;
    document.getElementById("riother_treatment").disabled = false;
    
  }
}


function git_involvement(){
    var a= document.getElementById('git').value;
  if(a == 'No'){
    document.getElementById("ibd").disabled = true;
    document.getElementById("ibd_duration").disabled = true;
    document.getElementById("ibd_treatment").disabled = true;
    document.getElementById("ibs").disabled = true;
    document.getElementById("ibs_duration").disabled = true;
    document.getElementById("ibs_treatment").disabled = true;
    document.getElementById("gerd").disabled = true;
    document.getElementById("gerd_duration").disabled = true;
    document.getElementById("gerd_treatment").disabled = true;
    document.getElementById("giother").disabled = true;
    document.getElementById("giother_duration").disabled = true;
    document.getElementById("giother_treatment").disabled = true;
  }
  else{
    document.getElementById("ibd").disabled = false;
    document.getElementById("ibd_duration").disabled = false;
    document.getElementById("ibd_treatment").disabled = false;
    document.getElementById("ibs").disabled = false;
    document.getElementById("ibs_duration").disabled = false;
    document.getElementById("ibs_treatment").disabled = false;
    document.getElementById("gerd").disabled = false;
    document.getElementById("gerd_duration").disabled = false;
    document.getElementById("gerd_treatment").disabled = false;
    document.getElementById("giother").disabled = false;
    document.getElementById("giother_duration").disabled = false;
    document.getElementById("giother_treatment").disabled = false;
    
  }
}

function neurological_involvement(){
    var a= document.getElementById('ni').value;
  if(a == 'No'){
    document.getElementById("stroke").disabled = true;
    document.getElementById("stroke_duration").disabled = true;
    document.getElementById("stroke_treatment").disabled = true;
    document.getElementById("parkinson").disabled = true;
    document.getElementById("parkinson_duration").disabled = true;
    document.getElementById("parkinson_treatment").disabled = true;
    document.getElementById("perin").disabled = true;
    document.getElementById("perin_duration").disabled = true;
    document.getElementById("perin_treatment").disabled = true;
    document.getElementById("sezdis").disabled = true;
    document.getElementById("sezdis_duration").disabled = true;
    document.getElementById("sezdis_treatment").disabled = true;
  }
  else{
    document.getElementById("stroke").disabled = false;
    document.getElementById("stroke_duration").disabled = false;
    document.getElementById("stroke_treatment").disabled = false;
    document.getElementById("parkinson").disabled = false;
    document.getElementById("parkinson_duration").disabled = false;
    document.getElementById("parkinson_treatment").disabled = false;
    document.getElementById("perin").disabled = false;
    document.getElementById("perin_duration").disabled = false;
    document.getElementById("perin_treatment").disabled = false;
    document.getElementById("sezdis").disabled = false;
    document.getElementById("sezdis_duration").disabled = false;
    document.getElementById("sezdis_treatment").disabled = false;
    
  }
}

function renal_involvement(){
    var a= document.getElementById('renal').value;
  if(a == 'No'){
    document.getElementById("ckd").disabled = true;
    document.getElementById("ckd_duration").disabled = true;
    document.getElementById("ckd_treatment").disabled = true;
    document.getElementById("rcalculi").disabled = true;
    document.getElementById("rcalculi_duration").disabled = true;
    document.getElementById("rcalculi_treatment").disabled = true;
    document.getElementById("renaloth").disabled = true;
    document.getElementById("renaloth_duration").disabled = true;
    document.getElementById("renaloth_treatment").disabled = true;
  }
  else{
    document.getElementById("ckd").disabled = false;
    document.getElementById("ckd_duration").disabled = false;
    document.getElementById("ckd_treatment").disabled = false;
    document.getElementById("rcalculi").disabled = false;
    document.getElementById("rcalculi_duration").disabled = false;
    document.getElementById("rcalculi_treatment").disabled = false;
    document.getElementById("renaloth").disabled = false;
    document.getElementById("renaloth_duration").disabled = false;
    document.getElementById("renaloth_treatment").disabled = false;
    
  }
}

function msk_involvement(){
    var a= document.getElementById('msk').value;
  if(a == 'No'){
    document.getElementById("pain").disabled = true;
    document.getElementById("pain_duration").disabled = true;
    document.getElementById("pain_treatment").disabled = true;
    document.getElementById("stiffness").disabled = true;
    document.getElementById("stiffness_duration").disabled = true;
    document.getElementById("stiffness_treatment").disabled = true;
    document.getElementById("deformity").disabled = true;
    document.getElementById("deformity_duration").disabled = true;
    document.getElementById("deformity_treatment").disabled = true;
    document.getElementById("mobility").disabled = true;
    document.getElementById("mobility_duration").disabled = true;
    document.getElementById("mobility_treatment").disabled = true;
  }
  else{
    document.getElementById("pain").disabled = false;
    document.getElementById("pain_duration").disabled = false;
    document.getElementById("pain_treatment").disabled = false;
    document.getElementById("stiffness").disabled = false;
    document.getElementById("stiffness_duration").disabled = false;
    document.getElementById("stiffness_treatment").disabled = false;
    document.getElementById("deformity").disabled = false;
    document.getElementById("deformity_duration").disabled = false;
    document.getElementById("deformity_treatment").disabled = false;
    document.getElementById("mobility").disabled = false;
    document.getElementById("mobility_duration").disabled = false;
    document.getElementById("mobility_treatment").disabled = false;
